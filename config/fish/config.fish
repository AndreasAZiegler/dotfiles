...
function docker-dev
  ...
  TERM=xterm rocker --nvidia --x11 --user --home --privileged --env TERM=xterm --name ros-dev --volume /dev/bus/usb:/dev/bus/usb --volume /data:/data -- tabletennis-prophesee-ros
end
